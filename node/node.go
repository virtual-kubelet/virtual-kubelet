...
func WithoutAutonomousHearbeatUpdates() NodeControllerOpt {
	return func(n *NodeController) error {
		n.disableAutonomousHeartbeatUpdates = true
		return nil
	}
}
...
type NodeController struct { // nolint: golint
	...
	// serverNode should be only be written to on initialization, or as the result of node creation.
	...
	disableAutonomousHeartbeatUpdates bool
}
...
func (n *NodeController) updateStatus(ctx context.Context, providerNode *corev1.Node, skipErrorCb bool) (err error) {
	...
	if !n.disableAutonomousHeartbeatUpdates {
