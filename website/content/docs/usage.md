...
> At this time, automation of this deployment is supported only for the [`mock`](https://github.com/iofog/virtual-kubelet/tree/master/providers/mock) provider.
